...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->time_progress_bar = (gcnew System::Windows::Forms::Timer(this->components));
			...
			this->combo_Nombre->Items->AddRange(gcnew cli::array< System::Object^  >(42) {
				L"", L"María", L"Carmen", L"Antonio", L"Manuel",
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(195, 5);
			...
			this->btn_pause->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->btn_pause->Location = System::Drawing::Point(286, 5);
			...
			this->lbl_Cronometro->Location = System::Drawing::Point(680, 11);
			this->lbl_Cronometro->Name = L"lbl_Cronometro";
			this->lbl_Cronometro->Size = System::Drawing::Size(103, 25);
			...
			this->lbl_Tiempo_Cronometro->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular,
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->lbl_Tiempo_Cronometro->Location = System::Drawing::Point(508, 11);
			this->lbl_Tiempo_Cronometro->Name = L"lbl_Tiempo_Cronometro";
			this->lbl_Tiempo_Cronometro->Size = System::Drawing::Size(166, 25);
			...
			this->lbl_Control_Pause->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 18, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->lbl_Control_Pause->Location = System::Drawing::Point(30, 8);
			...
			this->pic_Logo->Location = System::Drawing::Point(16, 498);
			...
			this->lbl_Atencion_1->Location = System::Drawing::Point(636, 30);
			this->lbl_Atencion_1->Name = L"lbl_Atencion_1";
			this->lbl_Atencion_1->Size = System::Drawing::Size(94, 16);
			this->lbl_Atencion_1->TabIndex = 2;
			this->lbl_Atencion_1->Text = L"lbl_Atencion_1";
			// 
			// progressBar1
			// 
			this->progressBar1->Location = System::Drawing::Point(819, 27);
			...
			// time_progress_bar
			// 
			this->time_progress_bar->Tick += gcnew System::EventHandler(this, &Simulador::time_progress_bar_Tick);
			// 
			// Simulador
			// 
			...
			this->FormClosed += gcnew System::Windows::Forms::FormClosedEventHandler(this, &Simulador::Simulador_FormClosed);
			...
			this->group_Atencion->PerformLayout();
...
#pragma endregion
	...
	public: void activarPanel_de_atención(int _paneles) {
		int distanciaPanel = 38;
		time_progress_bar->Start();

		// Crear un nuevo Panel
		Panel^ panel = gcnew Panel();
		panel->Anchor = static_cast<System::Windows::Forms::AnchorStyles>(((System::Windows::Forms::AnchorStyles::Top | System::Windows::Forms::AnchorStyles::Left)
			| System::Windows::Forms::AnchorStyles::Right));
		panel->Location = Point(15, 22 + distanciaPanel * _paneles);
		panel->Size = System::Drawing::Size(889, 34);
		panel->BackColor = Color::White;
		group_Atencion->Controls->Add(panel);

		// Crear una etiqueta para cada panel
		Label^ label = gcnew Label();
		label->AutoSize = true;
		label->Font = gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
			static_cast<System::Byte>(0));
		label->Location = System::Drawing::Point(7, 9);
		label->Size = System::Drawing::Size(623, 18);
		label->TabIndex = 0;
		label->ForeColor = Color::Black;
		label->Text = "El supervisor " + _nombre + " " + _apellido + " ha ordenado "
			+ _vegetariano + " vegetarianos, " + _regular + " regulares y " + _dieta + " dietéticos";
	...
	private: System::Void Simulador_FormClosed(System::Object^ sender, System::Windows::Forms::FormClosedEventArgs^ e) {
		if (MessageBox::Show("¿Desea cerrar el programa?", "Advertencia", MessageBoxButtons::YesNo, MessageBoxIcon::Information) == System::Windows::Forms::DialogResult::Yes) {
			// Se cerrará el programa solo si el usuario hace clic en "Sí"
			this->Close();
		}
