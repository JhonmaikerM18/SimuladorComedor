...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->text_vegetariano->Size = System::Drawing::Size(100, 26);
			...
			this->text_regular->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 12, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->text_regular->Location = System::Drawing::Point(293, 44);
			this->text_regular->Name = L"text_regular";
			this->text_regular->Size = System::Drawing::Size(100, 26);
			...
			this->text_dieta->Size = System::Drawing::Size(100, 26);
...
#pragma endregion
	...
	private: System::Void Cronometro_Tick(System::Object^ sender, System::EventArgs^ e) {
		...
		TimeSpan tiempoTranscurrido = TimeSpan::FromSeconds(timeCronometro);
		lbl_Cronometro->Text = String::Format(L"{0}:{1:D2} - PRUEBA", tiempoTranscurrido.Minutes, tiempoTranscurrido.Seconds);
	...
	private:  int generarNumeroAleatorio(int min, int max) {
		...
		return rnd->Next(min, max + 1);
		   ...
		   bool b_id = false, b_name = false, b_apellido = false, b_area = false, b_jerarquia = false, b_trabajadores = false,
			   b_vegetariano = false, b_regular = false, b_dieta = false;
